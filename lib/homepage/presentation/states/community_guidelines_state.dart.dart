                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Icon(folder, semanticLabel: AppLocalizations.of(context).translate('Folder icon')),
                        ...
                        RichText(
                          text: TextSpan(
                            children: [
                              ...
                              TextSpan(text: AppLocalizations.of(context).translate('resources '), recognizer: TapGestureRecognizer()..onTap = () => launchUrl(uriResources), style: Theme.of(context).textTheme.bodyLarge),
                              
                              TextSpan(text: '/ ', style: Theme.of(context).textTheme.bodyLarge),
                              
                              TextSpan(text: AppLocalizations.of(context).translate('community guidelines'), recognizer: TapGestureRecognizer()..onTap = () =>  launchUrl(uriResources), style: Theme.of(context).textTheme.bodyLarge)
                            ]
                          )
                        ),
                    ...
                    Text(AppLocalizations.of(context).translate('The Goyerv Community Guidelines'), style: Theme.of(context).textTheme.titleLarge),
                              ...
                              RichText(
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: AppLocalizations.of(context).translate(
                                        ''' - There new users that join the community each day. Some are well-established developers, while others are just beginning. Be understanding and open to the ideas of other people irrespective of their experience levels. Hear other people out and be welcoming to new members of the community\n\n'''
                                      ),
                                      style: Theme.of(context).textTheme.bodyLarge 
                                    ),
                                    ...
                                    TextSpan(
                                      text: AppLocalizations.of(context).translate(
                                        ''' - Goyerv is a global community with people from different backgrounds and perspectives, many of which may not be your own. Try putting yourself in others’ shoes and understanding their feelings before you addressing them. Let your contribution help make Goyerv community better; let it make it a community where members feel safer and free to share ideas and give their opinions.\n\n'''
                                      ),
                                      style: Theme.of(context).textTheme.bodyLarge 
                                    ),
                              ...
                              RichText(
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: AppLocalizations.of(context).translate(
                                        ''' - The Originator of a discussion can block certain users that they find offensive from replying or making comments in that discussion or any other discussions of theirs in the future. This helps in keeping certain user from making interactions in your discussion\n\n'''
                                      ),
                                      style: Theme.of(context).textTheme.bodyLarge 
                                    ),
                              ...
                              RichText(
                                text: TextSpan(
                                  children: [
                                    TextSpan(
                                      text: AppLocalizations.of(context).translate(
                                        '''Reports we get, as well as proactive detection, from members of the community help to ensure that Goyerv remains and stays safe safe and productive. We take into consideration a lot of factors whenever we get reports of content not in line with our  '''
                                      ),
